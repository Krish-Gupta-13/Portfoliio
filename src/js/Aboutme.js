  ...
  return (
    <div className='aboutmebody' id='aboutme'>
      ...
      <div className="holder">
          ...
          <div className="right">
              <p>Hii there, this is Krish Gupta from Bhilai, Chhattisgarh. Currently I am pursuing my Bachelors in Mining Engeneering from, one of the reputed college of our country, that is National Institute of Technology Raipur. 
